  ...
  return (
    <div className="contact-section" id="contact">
      ...
      <h3 className="contact-section__subheading">
        Feel free to contact me about any potential roles.
      </h3>
      <div className="contact-section__images">
        <a href="https://github.com/sultanp91" target="_blank" rel="noreferrer">
          <svg
            class="contact-section-svg"
        ...
        <a
          href="https://www.linkedin.com/in/sultan-parbes/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a href="mailto: sultanp@gmail.com" target="_blank" rel="noreferrer">
          <svg
            class="contact-section-svg"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
